...
public class MoviesService {
     ...
     *         Pattern} objects
     */
    protected List<Pattern> makePatternList(List<String> regexQueries) {
     ...
     * concurrently determine if the {@code pattern} matches any
     * {@link Movie} objects.
     *
    ...
    protected List<Movie> concatMatches
        ...
        // 
        // 3. Eliminate any duplicates in the Stream.
        //
        // 4. Convert the Stream to a List of Movie objects that are
