...
import edu.vandy.recommender.moviesex.server.utils.FutureUtils;
...
public class MoviesService {
    ...
    private static class NoSuchMatchException
            extends Exception {
        /**
         * Throw a custom {@link Exception} that is thrown if there's
         * no match between a query and a {@link Movie} title.
         *
         * @throws {@link NoSuchMatchException}
         */
        static public Movie throwNoSuchMatchException()
    ...
    protected List<Movie> convertMovieMatches(List<Future<Movie>> results) {
        // Call a helper method to convert the List of Future<Movie>>
        // objects to a List of Movie objects.
